    ...
    <div className="public-site">
      ...
      <section className="public-hero">
        ...
        <div className="public-hero-copy">
          <Eyebrow>منصة حكومية موحّدة</Eyebrow>
          <h1>
            من بيانات المدينة
            <br />
            <em>إلى قرار أوضح</em>
          ...
          <p>
            استنار يحوّل البيانات المكانية والقطاعية إلى توصيات قابلة للتفسير،
            تساعد الجهات والمستثمرين على معرفة أين يبدأ الأثر.
          </p>
          <div className="hero-ctas">
            <Button onClick={onLogin}>
              ابدأ استكشاف المدينة <ArrowUpLeft size={17} />
            </Button>
            <Button
              variant="ghost"
              onClick={() =>
      ...
      <section id="about" className="public-section intro-section">
        <div className="intro-copy">
          <Eyebrow dark>لماذا استنار؟</Eyebrow>
          <h2>
            الفجوة ليست في البيانات،
            <br />
            بل في تحويلها إلى اتجاه.
          </h2>
          <p>
            تربط استنار الموقع والطلب والخدمات والسكان والسياق القطاعي في طبقة
            قرار واحدة. النتيجة ليست رقماً إضافياً، بل إجابة يمكن شرحها
            ومراجعتها والعمل عليها.
          </p>
        </div>
        <div className="principles">
          <div>
            <span>01</span>
            <h3>يفهم السياق</h3>
            <p>يجمع المؤشرات التي يحتاجها القرار دون إغراق المستخدم.</p>
          </div>
          <div>
            <span>02</span>
            <h3>يشرح التوصية</h3>
            <p>يعرض أسباب القوة والمخاطر ومستوى الثقة والبدائل.</p>
          </div>
          <div>
            <span>03</span>
            <h3>يصل القرار بالأثر</h3>
            <p>يحوّل التحليل إلى مشروع أو تدخل قابل للمتابعة.</p>
          </div>
        </div>
      </section>
      <section id="domains" className="public-section domains-section">
        <div className="section-heading">
          <div>
            <Eyebrow dark>بيئات متخصصة تحت مظلة واحدة</Eyebrow>
            <h2>اختر السؤال الذي تريد الإجابة عنه</h2>
          </div>
        </div>
          ...
          {domains.map((domain) => (
            ...
            >
              ...
              <span className="card-link">
                استكشف النطاق <ArrowUpLeft size={15} />
              </span>
            </a>
          ))}
        </div>
      ...
      <section id="how" className="public-section how-section">
        <div className="how-visual">
          ...
          <div className="how-step">
            ...
            <div>
              <b>اختر هدفك</b>
              <small>استثمار، خدمة، صحة، سياحة أو نمو</small>
            </div>
          </div>
          <div className="how-step">
            <span>2</span>
            <div>
              <b>حدّد الحد الأدنى</b>
              <small>الموقع، النشاط، أو الفئة المستهدفة</small>
            </div>
          </div>
          <div className="how-step">
            <span>3</span>
            <div>
              <b>استلم نتيجة قابلة للفهم</b>
              <small>ترتيب، أسباب، ثقة، وبدائل</small>
            </div>
          </div>
        </div>
        <div>
          <Eyebrow dark>من السؤال إلى التوصية</Eyebrow>
          <h2>
            تجربة بسيطة
            <br />
            للأسئلة المعقدة
          ...
          <p>
            تبدأ الرحلة من هدف عملي، لا من لوحة مزدحمة. يمكن للخبير فتح الوضع
            المتقدم عند الحاجة، بينما يحصل المستخدم العادي على نتيجة مفيدة خلال
            دقائق.
          </p>
          <Button onClick={onLogin}>
            جرّب مساحة العمل <ArrowUpLeft size={16} />
          </Button>
        </div>
      </section>
      <section id="governance" className="governance-band">
        <div>
          <Eyebrow>بيانات مسؤولة وقرارات يمكن الدفاع عنها</Eyebrow>
          <h2>
            الثقة جزء من المنتج،
            <br />
            وليست طبقة لاحقة.
        ...
        <div className="governance-list">
          <span>
            <LockKeyhole size={17} /> صلاحيات حسب الدور
          </span>
          <span>
            <ShieldCheck size={17} /> أثر تدقيقي كامل
          </span>
          <span>
            <Target size={17} /> مؤشرات قابلة للمراجعة
          </span>
        </div>
      </section>
    ...
    <div className="auth-screen">
      <div className="auth-art">
        ...
        <div className="auth-art-copy">
          ...
          <h1>
            قرارات أوضح
            <br />
            <em>تبدأ من مكان واحد.</em>
          </h1>
          <p>
            مساحة عمل مؤسسية تربط البيانات المكانية بقرارات الحكومة والقطاعات
            والاستثمار.
          </p>
        </div>
      </div>
      <div className="auth-form-wrap">
        <button className="back-link" onClick={onBack}>
          <ArrowUpLeft size={16} /> العودة للموقع
        </button>
        <div className="auth-form">
          <Eyebrow dark>
            {mode === "login" ? "مساحة العمل الآمنة" : "انضم إلى استنار"}
          </Eyebrow>
          <h1>
            {mode === "login" ? "مرحباً بعودتك" : "اطلب الوصول إلى المنصة"}
          </h1>
          <p>
            {mode === "login"
              ? "أدخل بياناتك للوصول إلى مؤشراتك وتحليلاتك المحفوظة."
              : "سيراجع فريق المنصة طلبك ويرسل بيانات الدخول إلى الجهة المعتمدة."}
          </p>
          {mode === "request" && (
            <label>
              الاسم الكامل
              <input placeholder="مثال: محمد العتيبي" />
            </label>
          )}
          <label>
            البريد المؤسسي
            <input type="email" placeholder="name@entity.gov.sa" />
          </label>
          {mode === "request" && (
            <label>
              الجهة أو الإدارة
              <input placeholder="الجهة الحكومية أو الشركة" />
            </label>
          )}
          <label>
            كلمة المرور
            {mode === "login" && <a href="#reset">نسيت كلمة المرور؟</a>}
            <input type="password" placeholder="••••••••" />
          </label>
          <label className="check-row">
            <input type="checkbox" defaultChecked /> أوافق على شروط استخدام
            المنصة وسياسة البيانات
          </label>
